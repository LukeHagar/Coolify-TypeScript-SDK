 ...
 * Database data
 */
export type CreateDatabaseKeydbRequestBody = {
  /**
   * UUID of the server
   */
  serverUuid: string;
...
/** @internal */
export const CreateDatabaseKeydbRequestBody$inboundSchema: z.ZodType<
...
/** @internal */
export type CreateDatabaseKeydbRequestBody$Outbound = {
  server_uuid: string;
  project_uuid: string;
...
/** @internal */
export const CreateDatabaseKeydbRequestBody$outboundSchema: z.ZodType<
  CreateDatabaseKeydbRequestBody$Outbound,
  z.ZodTypeDef,
  CreateDatabaseKeydbRequestBody
> = z.object({
  serverUuid: z.string(),
 ...
 */
export namespace CreateDatabaseKeydbRequestBody$ {
  /** @deprecated use `CreateDatabaseKeydbRequestBody$inboundSchema` instead. */
  export const inboundSchema = CreateDatabaseKeydbRequestBody$inboundSchema;
  /** @deprecated use `CreateDatabaseKeydbRequestBody$outboundSchema` instead. */
  export const outboundSchema = CreateDatabaseKeydbRequestBody$outboundSchema;
  /** @deprecated use `CreateDatabaseKeydbRequestBody$Outbound` instead. */
  export type Outbound = CreateDatabaseKeydbRequestBody$Outbound;
}

export function createDatabaseKeydbRequestBodyToJSON(
  createDatabaseKeydbRequestBody: CreateDatabaseKeydbRequestBody,
): string {
  return JSON.stringify(
    CreateDatabaseKeydbRequestBody$outboundSchema.parse(
      createDatabaseKeydbRequestBody,
    ),
  );
}

export function createDatabaseKeydbRequestBodyFromJSON(
  jsonString: string,
): SafeParseResult<CreateDatabaseKeydbRequestBody, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) => CreateDatabaseKeydbRequestBody$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CreateDatabaseKeydbRequestBody' from JSON`,
  );
}
