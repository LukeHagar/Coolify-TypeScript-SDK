...
/** @internal */
export const CreateDatabaseDragonflyRequestBody$inboundSchema: z.ZodType<
...
/** @internal */
export type CreateDatabaseDragonflyRequestBody$Outbound = {
  server_uuid: string;
  project_uuid: string;
...
/** @internal */
export const CreateDatabaseDragonflyRequestBody$outboundSchema: z.ZodType<
  CreateDatabaseDragonflyRequestBody$Outbound,
  z.ZodTypeDef,
  CreateDatabaseDragonflyRequestBody
> = z.object({
  serverUuid: z.string(),
 ...
 */
export namespace CreateDatabaseDragonflyRequestBody$ {
  /** @deprecated use `CreateDatabaseDragonflyRequestBody$inboundSchema` instead. */
  export const inboundSchema = CreateDatabaseDragonflyRequestBody$inboundSchema;
  /** @deprecated use `CreateDatabaseDragonflyRequestBody$outboundSchema` instead. */
  export const outboundSchema =
    CreateDatabaseDragonflyRequestBody$outboundSchema;
  /** @deprecated use `CreateDatabaseDragonflyRequestBody$Outbound` instead. */
  export type Outbound = CreateDatabaseDragonflyRequestBody$Outbound;
}

export function createDatabaseDragonflyRequestBodyToJSON(
  createDatabaseDragonflyRequestBody: CreateDatabaseDragonflyRequestBody,
): string {
  return JSON.stringify(
    CreateDatabaseDragonflyRequestBody$outboundSchema.parse(
      createDatabaseDragonflyRequestBody,
    ),
  );
}

export function createDatabaseDragonflyRequestBodyFromJSON(
  jsonString: string,
): SafeParseResult<CreateDatabaseDragonflyRequestBody, SDKValidationError> {
  return safeParse(
    jsonString,
    (x) =>
      CreateDatabaseDragonflyRequestBody$inboundSchema.parse(JSON.parse(x)),
    `Failed to parse 'CreateDatabaseDragonflyRequestBody' from JSON`,
  );
}
