 ...
 * The build pack type.
 */
export type CreatePrivateGithubAppApplicationBuildPack = ClosedEnum<
  typeof CreatePrivateGithubAppApplicationBuildPack
>;

/**
 * The static image.
 */
export const CreatePrivateGithubAppApplicationStaticImage = {
  NginxAlpine: "nginx:alpine",
} as const;
/**
 * The static image.
 */
export type CreatePrivateGithubAppApplicationStaticImage = ClosedEnum<
  typeof CreatePrivateGithubAppApplicationStaticImage
>;

/**
 * How to set redirect with Traefik / Caddy. www<->non-www.
 */
export const CreatePrivateGithubAppApplicationRedirect = {
  Www: "www",
  NonWww: "non-www",
  Both: "both",
} as const;
 ...
 * How to set redirect with Traefik / Caddy. www<->non-www.
 */
export type CreatePrivateGithubAppApplicationRedirect = ClosedEnum<
 ...
 */
export type CreatePrivateGithubAppApplicationRequestBody = {
  /**
   * The project UUID.
   */
  projectUuid: string;
   ...
   * The static image.
   */
  staticImage?: CreatePrivateGithubAppApplicationStaticImage | undefined;
  /**
   * The install command.
   */
   ...
   * How to set redirect with Traefik / Caddy. www<->non-www.
   */
  redirect?: CreatePrivateGithubAppApplicationRedirect | null | undefined;
  /**
...
/** @internal */
export const CreatePrivateGithubAppApplicationBuildPack$inboundSchema:
  z.ZodNativeEnum<typeof CreatePrivateGithubAppApplicationBuildPack> = z
    .nativeEnum(CreatePrivateGithubAppApplicationBuildPack);

/** @internal */
export const CreatePrivateGithubAppApplicationBuildPack$outboundSchema:
  z.ZodNativeEnum<typeof CreatePrivateGithubAppApplicationBuildPack> =
    CreatePrivateGithubAppApplicationBuildPack$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace CreatePrivateGithubAppApplicationBuildPack$ {
  /** @deprecated use `CreatePrivateGithubAppApplicationBuildPack$inboundSchema` instead. */
  export const inboundSchema =
    CreatePrivateGithubAppApplicationBuildPack$inboundSchema;
  /** @deprecated use `CreatePrivateGithubAppApplicationBuildPack$outboundSchema` instead. */
  export const outboundSchema =
    CreatePrivateGithubAppApplicationBuildPack$outboundSchema;
}

/** @internal */
export const CreatePrivateGithubAppApplicationStaticImage$inboundSchema:
  z.ZodNativeEnum<typeof CreatePrivateGithubAppApplicationStaticImage> = z
    .nativeEnum(CreatePrivateGithubAppApplicationStaticImage);

/** @internal */
export const CreatePrivateGithubAppApplicationStaticImage$outboundSchema:
  z.ZodNativeEnum<typeof CreatePrivateGithubAppApplicationStaticImage> =
    CreatePrivateGithubAppApplicationStaticImage$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace CreatePrivateGithubAppApplicationStaticImage$ {
  /** @deprecated use `CreatePrivateGithubAppApplicationStaticImage$inboundSchema` instead. */
  export const inboundSchema =
    CreatePrivateGithubAppApplicationStaticImage$inboundSchema;
  /** @deprecated use `CreatePrivateGithubAppApplicationStaticImage$outboundSchema` instead. */
  export const outboundSchema =
    CreatePrivateGithubAppApplicationStaticImage$outboundSchema;
}

/** @internal */
export const CreatePrivateGithubAppApplicationRedirect$inboundSchema:
  z.ZodNativeEnum<typeof CreatePrivateGithubAppApplicationRedirect> = z
    .nativeEnum(CreatePrivateGithubAppApplicationRedirect);

/** @internal */
export const CreatePrivateGithubAppApplicationRedirect$outboundSchema:
  z.ZodNativeEnum<typeof CreatePrivateGithubAppApplicationRedirect> =
    CreatePrivateGithubAppApplicationRedirect$inboundSchema;

/**
 * @internal
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace CreatePrivateGithubAppApplicationRedirect$ {
  /** @deprecated use `CreatePrivateGithubAppApplicationRedirect$inboundSchema` instead. */
  export const inboundSchema =
    CreatePrivateGithubAppApplicationRedirect$inboundSchema;
  /** @deprecated use `CreatePrivateGithubAppApplicationRedirect$outboundSchema` instead. */
  export const outboundSchema =
    CreatePrivateGithubAppApplicationRedirect$outboundSchema;
}

/** @internal */
export const CreatePrivateGithubAppApplicationRequestBody$inboundSchema:
  z.ZodType<
  ...
  > = z.object({
    ...
    build_pack: CreatePrivateGithubAppApplicationBuildPack$inboundSchema,
    ...
    static_image: CreatePrivateGithubAppApplicationStaticImage$inboundSchema
      .optional(),
...
/** @internal */
export type CreatePrivateGithubAppApplicationRequestBody$Outbound = {
  project_uuid: string;
  server_uuid: string;
...
/** @internal */
export const CreatePrivateGithubAppApplicationRequestBody$outboundSchema:
  z.ZodType<
    CreatePrivateGithubAppApplicationRequestBody$Outbound,
    z.ZodTypeDef,
    CreatePrivateGithubAppApplicationRequestBody
  > = z.object({
    ...
    githubAppUuid: z.string(),
    gitRepository: z.string(),
    gitBranch: z.string(),
    portsExposes: z.string(),
    destinationUuid: z.string().optional(),
    buildPack: CreatePrivateGithubAppApplicationBuildPack$outboundSchema,
    name: z.string().optional(),
    description: z.string().optional(),
    domains: z.string().optional(),
    ...
    staticImage: CreatePrivateGithubAppApplicationStaticImage$outboundSchema
      .optional(),
 ...
 * @deprecated This namespace will be removed in future versions. Use schemas and types that are exported directly from this module.
 */
export namespace CreatePrivateGithubAppApplicationRequestBody$ {
  /** @deprecated use `CreatePrivateGithubAppApplicationRequestBody$inboundSchema` instead. */
  export const inboundSchema =
    CreatePrivateGithubAppApplicationRequestBody$inboundSchema;
  /** @deprecated use `CreatePrivateGithubAppApplicationRequestBody$outboundSchema` instead. */
  export const outboundSchema =
    CreatePrivateGithubAppApplicationRequestBody$outboundSchema;
  /** @deprecated use `CreatePrivateGithubAppApplicationRequestBody$Outbound` instead. */
  export type Outbound = CreatePrivateGithubAppApplicationRequestBody$Outbound;
}

export function createPrivateGithubAppApplicationRequestBodyToJSON(
  createPrivateGithubAppApplicationRequestBody:
    CreatePrivateGithubAppApplicationRequestBody,
): string {
  return JSON.stringify(
    CreatePrivateGithubAppApplicationRequestBody$outboundSchema.parse(
      createPrivateGithubAppApplicationRequestBody,
    ),
  );
}

export function createPrivateGithubAppApplicationRequestBodyFromJSON(
  jsonString: string,
): SafeParseResult<
  CreatePrivateGithubAppApplicationRequestBody,
  SDKValidationError
> {
  return safeParse(
    jsonString,
    (x) =>
      CreatePrivateGithubAppApplicationRequestBody$inboundSchema.parse(
        JSON.parse(x),
      ),
    `Failed to parse 'CreatePrivateGithubAppApplicationRequestBody' from JSON`,
  );
}
