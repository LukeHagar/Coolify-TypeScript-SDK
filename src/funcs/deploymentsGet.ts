...
export async function deploymentsGet(
  ...
  Result<
    components.ApplicationDeploymentQueue,
    | errors.BadRequest
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetDeploymentByUuidRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/deployments/{uuid}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, components.ApplicationDeploymentQueue$inboundSchema),
    M.jsonErr(
