 ...
 */
export async function servicesUpdateEnv(
  client: CoolifyCore,
  request: operations.UpdateEnvByServiceUuidRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.UpdateEnvByServiceUuidResponseBody,
    | errors.BadRequest
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateEnvByServiceUuidRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, operations.UpdateEnvByServiceUuidResponseBody$inboundSchema),
    M.jsonErr(
