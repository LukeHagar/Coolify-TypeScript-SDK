 ...
 */
export async function databasesCreateMongodb(
  client: CoolifyCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateDatabaseMongodbRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/databases/mongodb")();
