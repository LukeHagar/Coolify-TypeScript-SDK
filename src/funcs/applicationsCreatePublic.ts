 ...
 */
export async function applicationsCreatePublic(
  client: CoolifyCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreatePublicApplicationRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/applications/public")();
