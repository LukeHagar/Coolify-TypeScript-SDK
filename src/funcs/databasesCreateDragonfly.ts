 ...
 */
export async function databasesCreateDragonfly(
  client: CoolifyCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateDatabaseDragonflyRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/databases/dragonfly")();
