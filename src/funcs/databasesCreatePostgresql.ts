 ...
 */
export async function databasesCreatePostgresql(
  client: CoolifyCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateDatabasePostgresqlRequestBody$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/databases/postgresql")();
