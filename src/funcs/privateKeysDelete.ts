 ...
 */
export async function privateKeysDelete(
  client: CoolifyCore,
  request: operations.DeletePrivateKeyByUuidRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.DeletePrivateKeyByUuidResponseBody,
    | errors.BadRequest
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeletePrivateKeyByUuidRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/security/keys/{uuid}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.DeletePrivateKeyByUuidResponseBody$inboundSchema),
    M.jsonErr(
