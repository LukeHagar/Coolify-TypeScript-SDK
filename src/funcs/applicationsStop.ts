 ...
 */
export async function applicationsStop(
  client: CoolifyCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.StopApplicationByUuidRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/applications/{uuid}/stop")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.StopApplicationByUuidResponseBody$inboundSchema),
    M.jsonErr(
