 ...
 */
export async function databasesCreateMariadb(
  client: CoolifyCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateDatabaseMariadbRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/databases/mariadb")();
