 ...
 */
export async function servicesStop(
  client: CoolifyCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.StopServiceByUuidRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/services/{uuid}/stop")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.StopServiceByUuidResponseBody$inboundSchema),
    M.jsonErr(
