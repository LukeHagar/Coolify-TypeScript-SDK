...
export async function databasesDelete(
  ...
  Result<
    operations.DeleteDatabaseByUuidResponseBody,
    | errors.BadRequest
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteDatabaseByUuidRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/databases/{uuid}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.DeleteDatabaseByUuidResponseBody$inboundSchema),
    M.jsonErr(
