...
export async function projectsDelete(
  ...
  Result<
    operations.DeleteProjectByUuidResponseBody,
    | errors.BadRequest
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteProjectByUuidRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/projects/{uuid}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.DeleteProjectByUuidResponseBody$inboundSchema),
    M.jsonErr(
