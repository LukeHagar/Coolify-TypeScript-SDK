 ...
 */
export async function privateKeysUpdate(
  client: CoolifyCore,
  request: operations.UpdatePrivateKeyRequestBody,
  options?: RequestOptions,
): Promise<
  Result<
    operations.UpdatePrivateKeyResponseBody,
    | errors.BadRequest
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdatePrivateKeyRequestBody$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, operations.UpdatePrivateKeyResponseBody$inboundSchema),
    M.jsonErr(
