 ...
 */
export async function applicationsCreateEnv(
  client: CoolifyCore,
  request: operations.CreateEnvByApplicationUuidRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.CreateEnvByApplicationUuidResponseBody,
    | errors.BadRequest
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateEnvByApplicationUuidRequest$outboundSchema.parse(value),
  ...
  >(
    M.json(
      201,
      operations.CreateEnvByApplicationUuidResponseBody$inboundSchema,
    ),
    M.jsonErr(
