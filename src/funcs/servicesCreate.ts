...
export async function servicesCreate(
  ...
  Result<
    operations.CreateServiceResponseBody,
    | errors.BadRequest
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.CreateServiceRequestBody$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, operations.CreateServiceResponseBody$inboundSchema),
    M.jsonErr(
