 ...
 * Delete env by UUID.
 */
export async function servicesDeleteEnv(
  client: CoolifyCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteEnvByServiceUuidRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/services/{uuid}/envs/{env_uuid}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.DeleteEnvByServiceUuidResponseBody$inboundSchema),
    M.jsonErr(
