 ...
 */
export async function applicationsCreateDockerCompose(
  client: CoolifyCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateDockercomposeApplicationRequestBody$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/applications/dockercompose")();
