...
export async function servicesDelete(
  ...
  Result<
    operations.DeleteServiceByUuidResponseBody,
    | errors.BadRequest
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeleteServiceByUuidRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/services/{uuid}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.DeleteServiceByUuidResponseBody$inboundSchema),
    M.jsonErr(
