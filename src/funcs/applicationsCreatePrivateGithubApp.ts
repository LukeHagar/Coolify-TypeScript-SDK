 ...
 */
export async function applicationsCreatePrivateGithubApp(
  client: CoolifyCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreatePrivateGithubAppApplicationRequestBody$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/applications/private-github-app")();
