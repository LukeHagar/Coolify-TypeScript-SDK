 ...
 */
export async function servicesStart(
  client: CoolifyCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.StartServiceByUuidRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/services/{uuid}/start")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.StartServiceByUuidResponseBody$inboundSchema),
    M.jsonErr(
