 ...
 */
export async function databasesCreateClickhouse(
  client: CoolifyCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateDatabaseClickhouseRequestBody$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/databases/clickhouse")();
