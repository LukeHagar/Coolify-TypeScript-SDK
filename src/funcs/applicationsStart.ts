 ...
 */
export async function applicationsStart(
  client: CoolifyCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.StartApplicationByUuidRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/applications/{uuid}/start")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.StartApplicationByUuidResponseBody$inboundSchema),
    M.jsonErr(
