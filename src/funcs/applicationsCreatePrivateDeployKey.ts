 ...
 */
export async function applicationsCreatePrivateDeployKey(
  client: CoolifyCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreatePrivateDeployKeyApplicationRequestBody$outboundSchema
        .parse(value),
  ...
  const path = pathToFunc("/applications/private-deploy-key")();
