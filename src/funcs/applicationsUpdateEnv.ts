 ...
 */
export async function applicationsUpdateEnv(
  client: CoolifyCore,
  request: operations.UpdateEnvByApplicationUuidRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.UpdateEnvByApplicationUuidResponseBody,
    | errors.BadRequest
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateEnvByApplicationUuidRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/applications/{uuid}/envs")(pathParams);
  ...
  >(
    M.json(
      201,
      operations.UpdateEnvByApplicationUuidResponseBody$inboundSchema,
    ),
    M.jsonErr(
