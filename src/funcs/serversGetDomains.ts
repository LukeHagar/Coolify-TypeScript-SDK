 ...
 */
export async function serversGetDomains(
  client: CoolifyCore,
  request: operations.GetDomainsByServerUuidRequest,
  options?: RequestOptions,
): Promise<
  Result<
    Array<operations.GetDomainsByServerUuidResponseBody>,
    | errors.BadRequest
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetDomainsByServerUuidRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/servers/{uuid}/domains")(pathParams);
  ...
  >(
    M.json(
      200,
      z.array(operations.GetDomainsByServerUuidResponseBody$inboundSchema),
    ),
    M.jsonErr(
