 ...
 */
export async function applicationsUpdateEnvsBulk(
  client: CoolifyCore,
  request: operations.UpdateEnvsByApplicationUuidRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.UpdateEnvsByApplicationUuidResponseBody,
    | errors.BadRequest
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateEnvsByApplicationUuidRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/applications/{uuid}/envs/bulk")(pathParams);
  ...
  >(
    M.json(
      201,
      operations.UpdateEnvsByApplicationUuidResponseBody$inboundSchema,
    ),
    M.jsonErr(
