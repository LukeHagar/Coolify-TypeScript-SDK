...
export async function projectsUpdate(
  ...
  Result<
    operations.UpdateProjectByUuidResponseBody,
    | errors.BadRequest
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.UpdateProjectByUuidRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, operations.UpdateProjectByUuidResponseBody$inboundSchema),
    M.jsonErr(
