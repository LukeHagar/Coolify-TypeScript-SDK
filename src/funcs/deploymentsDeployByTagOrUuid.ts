 ...
 */
export async function deploymentsDeployByTagOrUuid(
  client: CoolifyCore,
  request: operations.DeployByTagOrUuidRequest,
  options?: RequestOptions,
): Promise<
  Result<
    operations.DeployByTagOrUuidResponseBody,
    | errors.BadRequest
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.DeployByTagOrUuidRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.DeployByTagOrUuidResponseBody$inboundSchema),
    M.jsonErr(
