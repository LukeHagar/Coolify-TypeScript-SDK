 ...
 */
export async function serversGetResources(
  client: CoolifyCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetResourcesByServerUuidRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/servers/{uuid}/resources")(pathParams);
