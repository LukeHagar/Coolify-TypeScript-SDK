 ...
 */
export async function projectsGetEnvironment(
  client: CoolifyCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetEnvironmentByNameRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/projects/{uuid}/{environment_name}")(pathParams);
