 ...
 */
export async function serversValidate(
  client: CoolifyCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ValidateServerByUuidRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/servers/{uuid}/validate")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, operations.ValidateServerByUuidResponseBody$inboundSchema),
    M.jsonErr(
