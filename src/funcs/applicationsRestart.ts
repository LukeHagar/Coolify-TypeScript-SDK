 ...
 */
export async function applicationsRestart(
  client: CoolifyCore,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.RestartApplicationByUuidRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/applications/{uuid}/restart")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, operations.RestartApplicationByUuidResponseBody$inboundSchema),
    M.jsonErr(
