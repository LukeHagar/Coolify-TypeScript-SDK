 ...
 */
export async function applicationsListEnvs(
  client: CoolifyCore,
  request: operations.ListEnvsByApplicationUuidRequest,
  options?: RequestOptions,
): Promise<
  Result<
    Array<components.EnvironmentVariable>,
    | errors.BadRequest
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListEnvsByApplicationUuidRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, z.array(components.EnvironmentVariable$inboundSchema)),
    M.jsonErr(
